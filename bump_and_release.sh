...
echo "Generating tools README for src/universal_mcp_unipile/app.py..."
universal_mcp readme src/universal_mcp_unipile/app.py

# Stage the changed file
git add pyproject.toml src/universal_mcp_unipile/README.md
